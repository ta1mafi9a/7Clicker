...
public class ClickerGui {
	...
	private final Color LIGHT_GRAY = new Color(139, 0, 0);
	private final Color DARK_GRAY = new Color(255, 0, 0);
	private final Color GREEN = new Color(0, 0, 0);

	public JFrame frame = new JFrame("QHC EVILCLICKER");

	public JPanel mainPane = new JPanel(null);
	public JPanel titleBar = new JPanel(null);
	public JPanel dropdown = new JPanel(null);

	public JLabel titleText = new JLabel("QHC EVILCLICKER");
